...
public static class QuestionnaireSchemaInitializer
{
    public static async Task EnsureCreatedAsync(BitalNegocioDbContext context, CancellationToken cancellationToken = default)
    {
        var sql = @"
